  ...
  return (
    <div className="p-4 md:p-6 bg-gray-50 min-h-screen">
      <div className="border border-gray-300 bg-white rounded-md shadow-sm">
        {/* ✅ HEADER SECTION */}
        <div className="border-b border-gray-200 bg-white px-4 py-2 flex justify-between items-center rounded-t-md">
          <h2 className="text-sm md:text-base font-normal text-gray-700">
            Comments Given By <span className="font-semibold">Sales Person</span>
          </h2>
          <button
            onClick={handleExport}
            className="bg-[#3b5ba8] hover:bg-[#314b8a] text-white text-xs font-medium px-4 py-1.5 rounded"
          >
            Export To Excel
          </button>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-4 w-full">
            ...
            <div className="flex relative">
              <DatePicker
                ...
                className="border border-gray-300 rounded-l-md p-2 w-48 text-sm text-gray-700 focus:outline-none focus:ring-1 focus:ring-[#00AEEF]"
