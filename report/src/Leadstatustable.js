...
const LeadsStatusTable = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#e5e9ec] flex justify-center items-start py-8">
      <div className="bg-white shadow-sm border border-gray-200 rounded-md w-[100%] max-w-6xl">
        {/* Header Controls */}
          ...
          <table className="w-full text-sm text-gray-700 border border-gray-200 border-collapse">
            <thead>
              <tr className="text-left">
                ...
                <th className="px-4 py-2 border border-gray-200 font-semibold uppercase text-xs text-left bg-gray-100">
                  Total Leads
                </th>
              </tr>
            </thead>
